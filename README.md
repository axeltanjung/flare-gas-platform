...
\- \*\*Target\*\*: `flare\_gas\_volume` (continuous, m³)
...
\- \*\*Target\*\*: `co2\_emission\_equivalent` (continuous, kg CO₂e)
...
\- \*\*Target\*\*: `flare\_event\_risk` (binary: 0/1)
...
│   │   ├── trainer\_xgboost.py         # XGBoost training

│   │   ├── trainer\_lightgbm.py        # LightGBM training

│   │   ├── trainer\_classifier.py      # Classification training
...
│   │   └── shap\_explainer.py          # SHAP analysis module

│   ├── services/

│   │   └── prediction\_service.py      # Inference service
...
│   └── synthetic\_flare\_gas\_generator.py
...
python synthetic\_flare\_gas\_generator.py --rows 150000
...
python -m backend.training.pipeline --data ./data/flare\_gas\_dataset.csv --models ./models
...
&#x20;   "combustion\_temperature": 890.0,

&#x20;   "ambient\_temperature": 28.5,

&#x20;   "wind\_speed": 4.2,

&#x20;   "humidity": 65.0,

&#x20;   "upstream\_pressure": 78.3,

&#x20;   "separator\_pressure": 42.1,

&#x20;   "compressor\_load": 72.0,

&#x20;   "valve\_opening\_percentage": 45.0,

&#x20;   "production\_rate": 1200.0
...
&#x20; "predicted\_volume\_m3": 245.67,

&#x20; "confidence\_interval\_lower": 197.52,

&#x20; "confidence\_interval\_upper": 293.82,

&#x20; "model\_version": "xgboost-v1.0"
